    ...
    return {
      ...
      TABLE_ITEM_LABEL_LIST: [
        ...
        },
        {
          ...
          options: [
            { label: "no", el: "el-radio" },
            { label: "yes", el: "el-radio" },
          ],
        ...
        },
        {
          ...
          options: [
            { label: "football", el: "el-checkbox" },
            { label: "swiming", el: "el-checkbox" },
          ],
        },
        { key: "avName", label: "片名", el: "el-input" },
        {
          key: "avNo",
          label: "番号",
          el: "el-input",
        ...
        },
        {
          key: "render",
          label: "render函数",
          render: (h) => <el-progress percentage={80}></el-progress>
        },
      ],
      formData: {
        rate: 2,
        ...
        render: () => {
          return (
            <CommonForm
              ...
              form-items={this.TABLE_ITEM_LABEL_LIST}
